...
<html>
	...
	<body>
		<div class="concert">
		<form:form modelAttribute="AdminConcertVO" id="form" name="update" enctype="multipart/form-data" action="modify">
			...
			<div class="concert_content">
				<table>
					<tr>
						<td>공연명</td>
						<td><form:input path="show_name" id="show_name" name="show_name"/></td>
					</tr>
					<tr>
						<td>공연회차</td>
						<td>
					...
					<tr>
						<td>공연 시작일</td>
						<td>
							<form:input type="date" path="show_startdate" id="show_startdate" name="show_startdate" max="2050-12-31" min="2023-01-01"/>
						</td>
					</tr>
					<tr>
						<td>공연 종료일</td>
						<td>
							<form:input type="date" path="show_closedate" id="show_closedate" name="show_closedate" max="2050-12-31" min="2023-01-01"/>
						</td>
					</tr>
					<tr>
						<td>공연 금액</td>
						<td>
							<form:input type="number" path="show_price" id="show_price" name="show_price" />
						</td>
					</tr>
					<tr>
						<td>공연 상태</td>
					...
					<tr>
						<td>장르</td>
						<td>
							<form:input path="concert_genre" id="concert_genre" name="concert_genre"/>
						</td>
					</tr>
					<tr>
						<td>밴드명</td>
						<td>
							<form:input path="concert_bandname" id="concert_bandname" name="concert_bandname"/>
						</td>
					</tr>
					...
					<tr>
						<td>아티스트</td>
						<td>
							<form:input path="concert_artist" id="concert_artist" name="concert_artist"/>
						</td>
					</tr>
