...
<html>
	<head>
		...
		<script src="/js/media/adminMediaReg.js"></script>
		<script type="text/javascript">
			$(document).ready(function(){
				var formObj = ${"#AdminMediaVO"};
	...
	<body>
		<div class="media">
		<form:form modelAttribute="AdminMediaVO" id="form" name="mediaReg" enctype="multipart/form-data" action="register">
			...
			<div class="media_content">
				<table>
					<tr>
						<td>공연명</td>
						<td><form:input path="show_name" id="show_name" name="show_name" placeholder="Ex) 추억의 명화" /></td>
					</tr>
					<tr>
						<td>공연회차</td>
						<td>
					...
					<tr>
						<td>작품명</td>
						<td>
							<form:input path="media_name" id="media_name" name="media_name" placeholder="Ex) 아기공룡 둘리 얼음별 대모험" />
						</td>
					</tr>
					<tr>
						<td>제작/감독</td>
						<td>
							<form:input path="media_director" id="media_director" name="media_director" placeholder="Ex) 김수정" />
						</td>
					</tr>
